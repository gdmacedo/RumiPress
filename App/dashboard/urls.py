...
urlpatterns = [
    ...
    path('about/', views.about, name='dashboard-about'), path('category/', CategoryListView.as_view(), name='dashboard-category'),
    path('category/<int:pk>/', BookCategoryListView.as_view(), name='category-detail'),
    path('author/<str:authors>/', AuthorBookListView.as_view(), name='author-books'),
